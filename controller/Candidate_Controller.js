...
exports.get_By_id_Candidate = async (req, res) => {
    try {
        ...
        const data = await candidates.findOne({
            ...
            .populate({
                path: "SponsorID",select: "userAddress Sponsor_Address Sponsor_name Check_sponsor Sponsor_Address1 Sponsor_name1 Check_sponsor1"
            })
...
exports.get_Candidate = async (req, res) => {
    try {
        ...
        let data = await candidates.find(query)
            .populate({
                path: "SponsorID",
select: "userAddress Sponsor_Address Sponsor_name Check_sponsor Sponsor_Address1 Sponsor_name1 Check_sponsor1"
            });
